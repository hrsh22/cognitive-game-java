...
class Game {
    public static class Controller {
        ...
        public Controller(Model model) {
            ...
            this.window.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE); // Close the window when the user
    ...
    public static class Model {
        ...
        static final String[] AVAILABLE_IMAGES = new String[] { "0.png", "1.png", "2.png", "3.png", "4.png", "5.png",
                "6.png", "7.png", "8.png" };
        ...
        public Model(int columns) {
            ...
            if (numberOfImage % 2 != 0)
                v.add(AVAILABLE_IMAGES.length - 1); // Add the last image if the number of images is odd
    ...
    public static class ButtonActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (disabledButtonCount == 2) { // If two buttons are disabled
                ...
                boolean isPair = thisIcon.getReference().equals(thatIcon.getReference()); // Check if the two images are
                                                                                          // the same
            ...
            ArrayList<JButton> enabledButtons = (ArrayList<JButton>) model.getButtons().stream()
                    .filter(Component::isEnabled).collect(Collectors.toList());
            ...
            if (model.getTries() == 0) { // If the number of tries is 0
                ...
                Utilities.timer(1000, (ignored) -> model.getButtons().forEach(btn -> btn.setEnabled(false))); // Wait 1s
                                                                                                              // before
                                                                                                              // disabling
                                                                                                              // all the
                                                                                                              // buttons
